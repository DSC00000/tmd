function getEnvironment() {
  var environment = {
    spreadsheetID: "1R5utokNDjBwWJQXXWNCvlRd5GpzEZJHJ_FLI7Y60Wo4",
    firebaseUrl: "https://telemetry-upload-default-rtdb.firebaseio.com/",
  };
  return environment;
}
...
function importSheet() {
  ...
  var firebaseUrl = getEnvironment().firebaseUrl + "production/";
